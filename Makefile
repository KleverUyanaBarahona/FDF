...
#    Updated: 2021/09/05 01:23:12 by klever           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

GNL= srcs/gnl/get_next_line_bonus.c
NAME= fdf.a
SRC= $(GNL) ./srcs/fdf/utils.c ./srcs/fdf/utils_fdf.c ./srcs/fdf/read_map.c #./srcs/fdf/draw.c ./srcs/fdf/utils_draw.c ./srcs/fdf/utils_fdf.c
